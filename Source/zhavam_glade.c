...
<interface>\
  ...
  <object class=\"GtkTextBuffer\" id=\"historyTextBuffer\">\
    <property name=\"text\" translatable=\"yes\">Zhavam was born because of I was looking for a Shazam-like\
application for Linux, but after several tries in internert I couldn't find \
something that gives me the basic functionality, this is, sound recognition.\
\
After looking for something related with music recognition in the web \
I found ACRCloud.\
\
ACRCloud gives you the services required for accessing their database\
...
access key and access secret required to start a session with teh server.\
\
...
Consulte la &lt;a href=\"https://www.gnu.org/licenses/gpl-3.0.html\"&gt;Licencia Pública General de GNU, versión 3 o posterior&lt;/a&gt; para obtener más detalles.</property>\
    <property name=\"authors\">ipserc (aka Jose Luis)</property>\
